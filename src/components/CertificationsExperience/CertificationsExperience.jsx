...
import {
  ...
  BsCalendar3, BsTagFill, BsArrowRight, BsGlobe2, BsBarChartFill,
} from 'react-icons/bs';
...
// ---- DUMMY DATA — placeholder hai, baad me real certificates se replace karna ----
...
// ---- Sidebar stats + quote shown inside the "View All" modal — placeholders,
// replace values/text with the real numbers once certificates are finalised ----
const certStats = [
...
// ---- DUMMY DATA — placeholder hai, baad me real work experience se replace karna.
// description/tags/tools sirf ExperienceModal (View All popup) ke detail panel me
// use hote hain — card list (neeche wala .certexp__exp-list) inhe touch nahi karta. ----
const experience = [
  {
